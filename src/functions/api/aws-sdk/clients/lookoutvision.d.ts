...
declare class LookoutVision extends Service {
   ...
   * 
   */
  describeTrialDetection(params: LookoutVision.Types.DescribeTrialDetectionRequest, callback?: (err: AWSError, data: LookoutVision.Types.DescribeTrialDetectionResponse) => void): Request<LookoutVision.Types.DescribeTrialDetectionResponse, AWSError>;
  /**
   * 
   */
  describeTrialDetection(callback?: (err: AWSError, data: LookoutVision.Types.DescribeTrialDetectionResponse) => void): Request<LookoutVision.Types.DescribeTrialDetectionResponse, AWSError>;
  /**
   ...
   * 
   */
  listTrialDetections(params: LookoutVision.Types.ListTrialDetectionsRequest, callback?: (err: AWSError, data: LookoutVision.Types.ListTrialDetectionsResponse) => void): Request<LookoutVision.Types.ListTrialDetectionsResponse, AWSError>;
  /**
   * 
   */
  listTrialDetections(callback?: (err: AWSError, data: LookoutVision.Types.ListTrialDetectionsResponse) => void): Request<LookoutVision.Types.ListTrialDetectionsResponse, AWSError>;
  /**
   ...
   * 
   */
  startTrialDetection(params: LookoutVision.Types.StartTrialDetectionRequest, callback?: (err: AWSError, data: LookoutVision.Types.StartTrialDetectionResponse) => void): Request<LookoutVision.Types.StartTrialDetectionResponse, AWSError>;
  /**
   * 
   */
  startTrialDetection(callback?: (err: AWSError, data: LookoutVision.Types.StartTrialDetectionResponse) => void): Request<LookoutVision.Types.StartTrialDetectionResponse, AWSError>;
  /**
...
declare namespace LookoutVision {
  ...
  export interface DescribeTrialDetectionRequest {
    ProjectName: ProjectName;
    TrialName: TrialName;
  }
  export interface DescribeTrialDetectionResponse {
    TrialDetectionDescription?: TrialDetectionDescription;
  }
  ...
  export interface ListTrialDetectionsRequest {
    ProjectName: ProjectName;
    ModelVersion?: ModelVersion;
    NextToken?: PaginationToken;
    MaxResults?: PageSize;
  }
  export interface ListTrialDetectionsResponse {
    TrialDetections?: TrialDetectionMetadataList;
    NextToken?: PaginationToken;
  }
  ...
  export interface StartTrialDetectionRequest {
    ProjectName: ProjectName;
    ModelVersion: ModelVersion;
    TrialName: TrialName;
    InputManifest: InputS3Object;
    OutputConfig: OutputConfig;
    ClientToken?: ClientToken;
    ModelEncryptionKmsKeyId?: KmsKeyId;
  }
  export interface StartTrialDetectionResponse {
    TrialArn?: TrialDetectionArn;
  }
  ...
  export type TrialDetectionArn = string;
  export interface TrialDetectionDescription {
    TrialArn?: TrialDetectionArn;
    TrialName?: TrialName;
    ModelVersion?: ModelVersion;
    Status?: TrialDetectionStatus;
    StatusMessage?: StatusMessage;
    InputManifest?: InputS3Object;
    OutputConfig?: OutputConfig;
    OutputManifest?: OutputS3Object;
    CreationTimestamp?: DateTime;
  }
  export interface TrialDetectionMetadata {
    TrialArn?: TrialDetectionArn;
    TrialName?: TrialName;
    ModelVersion?: ModelVersion;
    Status?: TrialDetectionStatus;
  ...
  export type TrialDetectionMetadataList = TrialDetectionMetadata[];
  export type TrialDetectionStatus = "CREATED"|"RUNNING"|"SUCCEEDED"|"FAILED"|string;
  export type TrialName = string;
